...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
            ...
            <div id="jsjobs-wrapper-top-left">
                <div id="jsjobs-breadcrunbs">
                    <ul>
                        ...
                        <li>
                            <a href="index.php?option=com_jsjobs&c=employerpackages&view=employerpackages&layout=formemployerpackage" title="<?php echo Text::_('Employer Package'); ?>">
                                <?php echo Text::_('Employer Package'); ?>
                            </a>
                        </li>
                        <li>
                            <?php
                            if (isset($this->application->id)){
                                echo Text::_('Edit Employer Package');
                            }else{
                                echo Text::_('Add').' '.Text::_('Employer Package');
                            } ?>
                        </li>
                    </ul>
                    </ul>
            ...
            <input type="hidden" name="check" value="post"/>
                ...
                <div class="js-form-wrapper">
                    ...
                    <div class="jsjobs-value">
                        <div class="js-form-wrapper"><span class="js-price"><?php echo $this->lists['currency']; ?></span></div>
                    <div class="js-form-wrapper">
                ...
                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="companiesallow"><?php echo Text::_('Companies Allow'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><input class="inputbox validate-numeric" type="text" name="companiesallow" id="companiesallow" size="40" maxlength="255" value="<?php if (isset($this->package)) echo $this->package->companiesallow; ?>" />&nbsp;<?php echo "-1 ".Text::_('To unlimited') ?> </div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="jobsallow"><?php echo Text::_('Job Allow'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><input class="inputbox validate-numeric" type="text" name="jobsallow" id="jobsallow" size="40" maxlength="255" value="<?php if (isset($this->package)) echo $this->package->jobsallow; ?>" />&nbsp;<?php echo "-1 ".Text::_('To unlimited') ?></div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="viewresumeindetails"><?php echo Text::_('View Resume In Details'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><input class="inputbox validate-numeric" type="text" name="viewresumeindetails" id="viewresumeindetails" size="40" maxlength="255" value="<?php if (isset($this->package)) echo $this->package->viewresumeindetails; ?>" />&nbsp;<?php echo "-1 ".Text::_('To unlimited') ?>&nbsp;&nbsp;<?php echo ' ( ' . Text::_('Effect On Applied Resume') . ' ) ' ?></div>
                </div>


                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="resumesearch"><?php echo Text::_('Resume Search'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><?php echo $this->lists['resumesearch']; ?></div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="saveresumesearch"><?php echo Text::_('Resume Save Search'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><?php echo $this->lists['saveresumesearch']; ?></div>
                </div>
                
                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="enforcestoppublishjob"><?php echo Text::_('Enforce Un-publish Job'); ?>:&nbsp;</label>
                ...
                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="enforcestoppublishjobvalue"><?php echo Text::_('Enforce Unpublish Value'); ?>:&nbsp;</label>
                ...
                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="enforcestoppublishjobtype"><?php echo Text::_('Enforce Unpublish Value Type'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><?php echo $this->lists['unpublishjobtype']; ?></div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="packageexpireindays"><?php echo Text::_('Expire In Days'); ?>:&nbsp;<font color="red">*</font></label>
                ...
                if (isset($this->paymentmethodlink)) {
                    ...
                    <div class="js-form-wrapper">
                        ...
                        <?php echo Text::_($paymethodlink->title); ?> <?php
        ...
        <div class="js-buttons-area">
            <input type="submit" class="js-btn-save" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo Text::_('Save Employer Package'); ?>" />
            <a class="js-btn-cancel" href="index.php?option=com_jsjobs&c=employerpackages&view=employerpackages&layout=employerpackages"><?php echo Text::_('Cancel'); ?></a>
        </div>
