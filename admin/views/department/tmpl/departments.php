...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
        ...
        <div id="jsjobs-head">
            ...
            <a onclick="Joomla.submitbutton('department.add');" class="jsjobs-add-link green-bg button" title="<?php echo Text::_('Add New').' '.Text::_('Department'); ?>">
                <img alt="<?php echo Text::_('Plus Icon'); ?>" src="components/com_jsjobs/include/images/plus.png"/>
                <?php echo Text::_('Add New').' '.Text::_('Department'); ?>
            </a>
        </div>
            ...
            <form action="index.php" method="post" name="adminForm" id="adminForm">
               ...
               ?>
                <div id="jsjobs_filter_wrapper">
                    ...
                    <span class="jsjobs-filter"><input type="text" name="searchcompany" placeholder="<?php echo Text::_('Company Name'); ?>"  id="searchcompany" size="15" <?php if($this->companyid) echo 'readonly'; ?> value="<?php echo $cname; ?>"/></span>
