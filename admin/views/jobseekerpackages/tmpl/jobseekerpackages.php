...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
        ...
        <div id="jsjobs-head">
            ...
            <a onclick="Joomla.submitbutton('jobseekerpackages.add');" class="jsjobs-add-link green-bg button" title="<?php echo Text::_('Add').' '.Text::_('Job Seeker Package'); ?>">
                <img alt="<?php echo Text::_('Plus Icon'); ?>" src="components/com_jsjobs/include/images/plus.png"/>
                <?php echo Text::_('Add').' '.Text::_('Job Seeker Package'); ?>
            </a>
        </div>
                ...
                <?php if(!empty($this->items)){ ?>
                    <table class="adminlist" border="0" id="js-table">
                        ...
                        for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                            ...
                            $link = OutputFilter::ampReplace('index.php?option=' . $this->option . '&task=jobseekerpackages.edit&cid[]=' . $row->id);
                            ...
                            <tr valign="top" class="<?php echo "row$k"; ?>">
                                ...
                                <td align="center"><?php if($row->price == 0){ echo Text::_('Free');
                                    }else{ 
                                        if($currency_align == 1)
