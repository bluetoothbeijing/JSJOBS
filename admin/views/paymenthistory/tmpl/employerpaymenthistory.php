                ...
                <div id="jsjobs-breadcrunbs">
                    <ul>
                        <li>
                         ...
                         <li>
                            <?php echo Text::_('Employer Payment History'); ?>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <table class="adminlist" border="0" id="js-table">
                    <thead>
                        <tr>
                            ...
                            <th class="title"><?php echo Text::_('Title'); ?></th>
                            <th class="title"><?php echo Text::_('Employer Name'); ?></th>
                            <?php /*<th><?php echo Text::_('Company Name'); ?></th>*/ ?>
                    ...
                    for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                        ...
                        <tr valign="top" class="<?php echo "row$k"; ?>">
                            ...
                            <td class="center">
                                ...
                                <a onclick='return confirm("<?php echo Text::_('Are You Sure')."?"; ?>");' href="<?php echo $status_link;?>">
                                    <img class="width-auto" src="components/com_jsjobs/include/images/<?php echo $approveimg; ?>" alt="<?php echo $approvealt; ?>" /></a>
                                <?php $status_link = OutputFilter::ampReplace('index.php?option='.$this->option.'&task=paymenthistory.'.$rejecttask.'&cid[]='.$row->id.'&'.$token.'=1'); ?>
                                &nbsp;&nbsp; - &nbsp;&nbsp
                                <a  onclick='return confirm("<?php echo Text::_('Are You Sure')."?"; ?>");' href="<?php echo $status_link;?>">
                                    <img class="width-auto" src="components/com_jsjobs/include/images/<?php echo $rejectimg; ?>" alt="<?php echo $rejectalt; ?>" /></a>
