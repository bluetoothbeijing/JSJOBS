...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
        ...
        <div class="js-phd-head"><?php echo Text::_($this->items->packagetitle); ?></div>
        ...
        <div id="js-phd-data" class="js-phd-data">
            ...
            <div class="js-phd-row bg">
                ...
                <div class="js-col-xs-12 js-col-md-3 js-phd-value"><?php echo $this->items->payer_itemname2;?></div>
            </div>
            <div class="js-phd-row">
            ...
            <div class="js-phd-row">
                ...
                <div class="js-col-xs-12 js-col-md-3 js-phd-value">
                    <?php if($this->items->verifieddate != ''){ ?>
                        <?php echo HTMLHelper::_('date', $this->items->verifieddate, $this->config['date_format']); ?>
                    <?php } ?>
                </div>
            </div>
            <div class="js-phd-row bg">
