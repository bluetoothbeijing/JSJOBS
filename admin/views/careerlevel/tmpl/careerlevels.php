...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
        ...
        <div id="jsjobs-head">
            ...
            <a onclick="Joomla.submitbutton('careerlevel.editcareerlevels');" class="jsjobs-add-link green-bg button" title="<?php echo Text::_('Add New').' '.Text::_('Career Level'); ?>">
                <img alt="<?php echo Text::_('Plus Icon'); ?>" src="components/com_jsjobs/include/images/plus.png"/>
                <?php echo Text::_('Add New').' '.Text::_('Career Level'); ?>
            </a>
        </div>
                ...
                <?php if(!empty($this->items)){ ?>
                        <table class="adminlist" border="0" id="js-table">
                            ...
                            for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                                ...
                                $link = OutputFilter::ampReplace('index.php?option=' . $this->option . '&task=careerlevel.editcareerlevels&cid[]=' . $row->id);
                                ?>
                                <tr valign="top" class="<?php echo "row$k"; ?>">
                                    ...
                                    <td align="center">
                                        ...
                                        $status_link = OutputFilter::ampReplace('index.php?option='.$this->option.'&task=common.makePublishUnpublish&for=careerlevels&status='.$status_value.'&cid[]='.$row->id);
                                        ?>
