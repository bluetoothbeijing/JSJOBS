    ...
    <div id="jsjobs-content">
            ...
            <div id="jsjobs-wrapper-top-left">
                <div id="jsjobs-breadcrunbs">
                    <ul>
                        ...
                        <li>
                            <a href="index.php?option=com_jsjobs&c=salaryrangetype&view=salaryrangetype&layout=salaryrangetype" title="<?php echo Text::_('Salary Range Type'); ?>">
                        ...
                        <li>
                            ...
                            if (isset($this->application->id)){
                                echo Text::_('Edit Salary Range Type');
                            }else{
                                echo Text::_('Form Salary Range Type');
                            } ?>
                        </li>
                    </ul>
                    </ul>
        ...
        <form action="index.php" method="POST" name="adminForm" id="adminForm" >
            ...
            <div class="js-buttons-area">
                <input type="submit" class="js-btn-save" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo Text::_('Save Salary Range Type'); ?>" />
                <a class="js-btn-cancel" href="index.php?option=com_jsjobs&c=salaryrangetype&view=salaryrangetype&layout=salaryrangetype"><?php echo Text::_('Cancel'); ?></a>
            </div>
