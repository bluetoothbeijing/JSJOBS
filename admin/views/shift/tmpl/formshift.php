...
<div id="jsjobs-wrapper">
            ...
            <div id="jsjobs-wrapper-top-left">
                <div id="jsjobs-breadcrunbs">
                    <ul>
                        ...
                        <li>
                            <a href="index.php?option=com_jsjobs&c=shift&view=shift&layout=shifts" title="<?php echo Text::_('Shifts'); ?>">
                        ...
                        <li>
                            ...
                            if (isset($this->application->id)){
                                echo Text::_('Edit Shifts');
                            }else{
                                echo Text::_('Add').' '.Text::_('Shifts');
                            } ?>
                        </li>
                    </ul>
                    </ul>
    ...
    ?>/>  
                ...
                <div class="js-buttons-area">
                    <input type="submit" class="js-btn-save" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo Text::_('Save Shift'); ?>" />
                    <a class="js-btn-cancel" href="index.php?option=com_jsjobs&c=shift&view=shift&layout=shifts"><?php echo Text::_('Cancel'); ?></a>
                </div>
