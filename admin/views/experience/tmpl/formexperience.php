            ...
            <div id="jsjobs-wrapper-top-left">
                <div id="jsjobs-breadcrunbs">
                    <ul>
                        ...
                        <li>
                            <a href="index.php?option=com_jsjobs&c=experience&view=experience&layout=experience" title="<?php echo Text::_('Experience'); ?>">
                        ...
                        <li>
                            ...
                            if (isset($this->application->id)){
                                echo Text::_('Edit Experience');
                            }else{
                                echo Text::_('Add').' '.Text::_('Experience');
                            } ?>
                        </li>
                    </ul>
                    </ul>
        ...
        <div id="jsstadmin-data-wrp">
            <form action="index.php" method="POST" name="adminForm" id="adminForm" >
                ...
                <div class="js-buttons-area">
                    <input type="submit" class="js-btn-save" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo Text::_('Save Experience'); ?>" />
                    <a class="js-btn-cancel" href="index.php?option=com_jsjobs&c=experience&view=experience&layout=experience"><?php echo Text::_('Cancel'); ?></a>
                </div>
