            ...
            <div id="jsjobs-wrapper-top-left">
                <div id="jsjobs-breadcrunbs">
                    <ul>
                        ...
                        <li>
                            <a href="index.php?option=com_jsjobs&c=state&view=state&layout=states" title="<?php echo Text::_('States'); ?>">
                        ...
                        <li>
                            ...
                            if (isset($this->state->id)){
                                echo Text::_('Edit State');
                            }else{
                                echo Text::_('Form State');
                            } ?>
                        </li>
                    </ul>
                    </ul>
...
?>/></span> <label class="js-publish" for="status" ><?php echo Text::_('Publish'); ?></label>
            ...
            <div class="js-buttons-area">
                <input type="submit" class="js-btn-save" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo Text::_('Save State'); ?>" />
                <a class="js-btn-cancel" href="index.php?option=com_jsjobs&c=state&view=state&layout=states"><?php echo Text::_('Cancel'); ?></a>
            </div>
