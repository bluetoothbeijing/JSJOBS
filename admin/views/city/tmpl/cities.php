...
$sort_combo = array(
    ...
    '1' => array('value' => 1, 'text' => Text::_('City Name')),
    ...
    <div id="jsjobs-content">
            ...
            <div id="jsjobs-wrapper-top-left">
                <div id="jsjobs-breadcrunbs">
                    <ul>
                        ...
                        <li>
                            <a href="index.php?option=com_jsjobs&c=state&view=state&layout=states&ct=<?php echo $countryid; ?>" title="<?php echo Text::_('States'); ?>">
                                <?php echo Text::_('States'); ?>
                            </a>
                        </li>
                        <li>
                            <?php
        ...
        <div id="jsjobs-head">
            <h1 class="jsjobs-head-text">
                <?php
                    echo Text::_('States').' > '.Text::_('Cities');
                 ?>
            </h1>
            <a onclick="Joomla.submitbutton('city.editjobcity');" class="jsjobs-add-link green-bg button" title="<?php echo Text::_('Add New').' '.Text::_('City'); ?>">
                <img alt="<?php echo Text::_('Plus Icon'); ?>" src="components/com_jsjobs/include/images/plus.png"/>
                <?php echo Text::_('Add New').' '.Text::_('City'); ?>
            </a>
        </div>
        ...
        <?php if(!empty($this->items)){ ?>
                <table class="adminlist" border="0" id="js-table">
                    ...
                    for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                        ...
                        $link = OutputFilter::ampReplace('index.php?option=' . $this->option . '&task=city.editjobcity&cid[]=' . $row->id);
                        ?>
                        <tr valign="top" class="<?php echo "row$k"; ?>">
                            ...
                            <td align="center">
                                ...
                                ?>
                                <a href="index.php?option=com_jsjobs&c=common&task=city.<?php echo $functionname; ?>&cid[]=<?php echo $row->id; ?>">
