...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
        ...
        <div id="jsjobs-head">
            ...
            <a onclick="Joomla.submitbutton('currency.editjobcurrency');" class="jsjobs-add-link green-bg button" title="<?php echo Text::_('Add New').' '.Text::_('Currency'); ?>">
                <img alt="<?php echo Text::_('Plus Icon'); ?>" src="components/com_jsjobs/include/images/plus.png"/>
                <?php echo Text::_('Add New').' '.Text::_('Currency'); ?>
            </a>
        </div>
        <div id="jsstadmin-data-wrp" class="p0 bg-n bs-n">
            ...
            <div id="jsjobs_filter_wrapper">           
                ...
                <span class="jsjobs-filter"><input type="text" name="searchcode" placeholder="<?php echo Text::_('Code'); ?>" id="searchcode" maxlength="3" value="<?php if (isset($this->lists['searchcode'])) echo $this->lists['searchcode']; ?>"  /></span>
                ...
                <span class="jsjobs-filter jsjobs-filter-btn-wrp"><button class="js-button js-form-reset" onclick="document.getElementById('searchcode').value = '';document.getElementById('searchstatus').value = '';document.getElementById('searchtitle').value = ''; this.form.submit();"><?php echo Text::_('Reset'); ?></button></span>
            </div>
                    ...
                    <table class="adminlist" border="0" id="js-table">
                        <thead>
                            <tr>
                                ...
                                <th class="center"><?php echo Text::_('Currency'); ?></th>
                                <th class="center"><?php echo Text::_('Code'); ?></th>
                        ...
                        for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                            ...
                            $link = OutputFilter::ampReplace('index.php?option=' . $this->option . '&task=currency.editjobcurrency&cid[]=' . $row->id);
                            ?>
                            <tr valign="top" class="<?php echo "row$k"; ?>">

                                <td><?php echo $checked; ?></td>
                                <td><a href="<?php echo $link; ?>"><?php echo Text::_($row->title); ?></a></td>
                                ...
                                <td align="center">
                                    ...
                                    <?php } else { ?>
                                        <a href="index.php?option=com_jsjobs&c=common&task=currency.makedefaultcurrency&cid[]=<?php echo $row->id; ?>">
                                ...
                                <td align="center">
                                    ...
                                    $status_link = OutputFilter::ampReplace('index.php?option='.$this->option.'&task=common.makePublishUnpublish&for=currency&status='.$status_value.'&cid[]='.$row->id);
                                    ?>
