...
<div id="jsjobs-wrapper">
            ...
            <div id="jsjobs-wrapper-top-left">
                <div id="jsjobs-breadcrunbs">
                    <ul>
                        ...
                        <li>
                            <a href="index.php?option=com_jsjobs&c=jobstatus&view=jobstatus&layout=jobstatus" title="<?php echo Text::_('Dashboard'); ?>">
                        ...
                        <li>
                            ...
                            if (isset($this->application->id)){
                                echo Text::_('Edit Job Status');
                            }else{
                                echo Text::_('Add').' '.Text::_('Job Status');
                            } ?>
                        </li>
                    </ul>
                    </ul>
    ...
    ?>/></span> <label class="js-publish" for="status" ><?php echo Text::_('Publish'); ?></label>
                ...
                <div class="js-buttons-area">
                    <input type="submit" class="js-btn-save" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo Text::_('Save Job Status'); ?>" />
                    <a class="js-btn-cancel" href="index.php?option=com_jsjobs&c=jobstatus&view=jobstatus&layout=jobstatus"><?php echo Text::_('Cancel'); ?></a>
                </div>
