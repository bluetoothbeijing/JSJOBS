                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            if (isset($this->country->id)){
                                echo Text::_('Edit Country');
                            }else{
                                echo Text::_('Add').' '.Text::_('Country');
                            } ?>
                        </li>
                    </ul>
                    </ul>
...
?>/></span> <label class="js-publish" for="status" ><?php echo Text::_('Publish'); ?></label>
            ...
            <div class="js-buttons-area">
                <input type="submit" class="js-btn-save" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo Text::_('Save Country'); ?>" />
                <a class="js-btn-cancel" href="index.php?option=com_jsjobs&c=country&view=country&layout=countries"><?php echo Text::_('Cancel'); ?></a>
            </div>
        </form>
    </div>
    </div>
