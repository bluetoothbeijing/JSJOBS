...
$sort_combo = array(
    ...
    '1' => array('value' => 1, 'text' => Text::_('Country Name')),
...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
        ...
        <div id="jsjobs-head">
            ...
            <a onclick="Joomla.submitbutton('country.editjobcountry');" class="jsjobs-add-link green-bg button" title="<?php echo Text::_('Add New').' '.Text::_('Country'); ?>">
                <img alt="<?php echo Text::_('Plus Icon'); ?>" src="components/com_jsjobs/include/images/plus.png"/>
                <?php echo Text::_('Add New').' '.Text::_('Country'); ?>
            </a>
        </div>
      ...
      <form action="index.php?option=com_jsjobs" method="post" name="adminForm" id="adminForm">
         <div id="jsjobs_filter_wrapper">
            ...
            <span class="jsjobs-filter"><div class="mycheckboxblock"><input type="checkbox" class="jsinputstate" id="hasstates" name="hasstates" value="" <?php if (isset($this->lists['hasstates'])) echo "checked"; ?> /><label id="hasstates" for="hasstates" name="hasstates" class="jshasstates"><?php echo Text::_('Has States'); ?></label></div></span>
                ...
                <table class="adminlist" border="0" id="js-table">
                    <thead>
                        <tr>
                            ...
                            <th width="13%" class="center"><?php echo Text::_('States'); ?></th>
                    ...
                    for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                        ...
                        $link = OutputFilter::ampReplace('index.php?option=' . $this->option . '&task=country.editjobcountry&cid[]=' . $row->id);
                        ?>
                        <tr valign="top" class="<?php echo "row$k"; ?>">
                            ...
                            <td align="center">
                                ...
                                ?>
                                <a href="index.php?option=com_jsjobs&c=common&task=country.<?php echo $functionname; ?>&cid[]=<?php echo $row->id; ?>">
                                    <img src="components/com_jsjobs/include/images/<?php echo $img; ?>"  /></a>
                                </a>    
                            </td>
                            <td class="center"><a href="index.php?option=com_jsjobs&c=state&view=state&layout=states&ct=<?php echo $row->id; ?>"><?php echo Text::_('States'); ?></a></td>
                            <td class="center"><a href="index.php?option=com_jsjobs&c=city&view=city&layout=cities&ct=<?php echo $row->id; ?>"><?php echo Text::_('Cities'); ?></a></td>
                        </tr>
                        <?php
                        $k = 1 - $k;
                    }
