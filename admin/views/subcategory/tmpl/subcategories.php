...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
                ...
                <div id="jsjobs-breadcrunbs">
                    <ul>
                        ...
                        <li>
                         ...
                         <li>
                            <?php echo Text::_('Sub Categories'); ?>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div id="jsjobs-head">
            ...
            <a onclick="Joomla.submitbutton('subcategory.editsubcategories');" class="jsjobs-add-link green-bg button" title="<?php echo Text::_('Add New').' '.Text::_('Sub Category'); ?>">
                <img alt="<?php echo Text::_('Plus Icon'); ?>" src="components/com_jsjobs/include/images/plus.png"/>
                <?php echo Text::_('Add New').' '.Text::_('Sub Category'); ?>
            </a>
        </div>
                ...
                <table class="adminlist" border="0" id="js-table">
                    <thead>
                        <tr>
                            ...
                            <th width="60%" class="title"><?php echo Text::_('Subcategory'); ?></th>
                    ...
                    for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                        ...
                        $link = OutputFilter::ampReplace('index.php?option=' . $this->option . '&task=subcategory.editsubcategories&cid[]=' . $row->id);
                        ?>
                        <tr valign="top" class="<?php echo "row$k"; ?>">
                            ...
                            <td align="center">
                                ...
                                $status_link = OutputFilter::ampReplace('index.php?option='.$this->option.'&task=common.makePublishUnpublish&for=subcategories&status='.$status_value.'&cid[]='.$row->id);
                                ?>
                    ...
                    <tr>
                        <td colspan="9" align="right">
                            <a href="index.php?option=com_jsjobs&task=subcategory.setorderingsubcategories&cd=<?php echo $categoryid; ?>"><?php echo Text::_('Set Ordering') ?></a>
                        </td>
                    </tr>
                   </tbody>
                </table>
    ...
    function setordering(catid) {
        jQuery.ajax({
            ...
            success: function (data) {
                if (data == true)
                    alert("<?php echo Text ::_("Ordering set") ?>");
                else
                    alert("<?php echo Text ::_("Error in changing ordering") ?>");
            }
        });
