            ...
            <div id="jsjobs-wrapper-top-left">
                <div id="jsjobs-breadcrunbs">
                    <ul>
                        ...
                        <li>
                            <a href="index.php?option=com_jsjobs&c=subcategory&view=subcategory&layout=subcategories&cd=<?php echo $this->categoryid;?>" title="<?php echo Text::_('Sub Category'); ?>">
                        ...
                        <li>
                            ...
                            if (isset($this->subcategory->id)){
                                echo Text::_('Edit Sub Category');
                            }else{
                                echo Text::_('Form Sub Category');
                            } ?>
                        </li>
                    </ul>
                    </ul>
        ...
        <form action="index.php" method="POST" name="adminForm" id="adminForm" >
            <div class="js-form-area">
                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for=""><strong><?php echo Text::_('Category'); ?>:&nbsp;</strong></label>
                    <div class="jsjobs-value"><strong>&nbsp;<?php if (isset($this->subcategory)) echo $this->subcategory->cat_title; ?></strong></div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="title"><?php echo Text::_('Category Title'); ?>:&nbsp;</label>
...
?>" />
            ...
            <div class="js-buttons-area">
                <input type="submit" class="js-btn-save" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo Text::_('Save Sub Category'); ?>" />
                <a class="js-btn-cancel" href="index.php?option=com_jsjobs&c=subcategory&view=subcategory&layout=subcategories&cd=1"><?php echo Text::_('Cancel'); ?></a>
            </div>
