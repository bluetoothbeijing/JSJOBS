            ...
            <div id="jsjobs-wrapper-top-left">
                <div id="jsjobs-breadcrunbs">
                    <ul>
                        ...
                        <li>
                            <a href="index.php?option=com_jsjobs&c=age&view=age&layout=ages" title="<?php echo Text::_('Ages'); ?>">
                        ...
                        <li>
                            ...
                            if (isset($this->application->id)){
                                echo Text::_('Edit Age');
                            }else{
                                echo Text::_('Add').' '.Text::_('Age');
                            } ?>
                        </li>
                    </ul>
                    </ul>
        ...
        <div id="jsstadmin-data-wrp">
            <form action="index.php" method="POST" name="adminForm" id="adminForm">
                ...
                <div class="js-buttons-area">
                    <input type="submit" class="js-btn-save" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo Text::_('Save Age'); ?>" />
                    <a class="js-btn-cancel" href="index.php?option=com_jsjobs&c=age&view=age&layout=ages"><?php echo Text::_('Cancel'); ?></a>
                </div>
