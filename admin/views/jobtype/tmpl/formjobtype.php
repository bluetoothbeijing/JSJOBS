            ...
            <div id="jsjobs-wrapper-top-left">
                <div id="jsjobs-breadcrunbs">
                    <ul>
                        ...
                        <li>
                            <a href="index.php?option=com_jsjobs&c=jobtype&view=jobtype&layout=jobtypes" title="<?php echo Text::_('Dashboard'); ?>">
                        ...
                        <li>
                            ...
                            if (isset($this->application->id)){
                                echo Text::_('Edit').' '.Text::_('Job Type');
                            }else{
                                echo Text::_('Add').' '.Text::_('Job Type');
                            } ?>
                        </li>
                    </ul>
                    </ul>
        ...
        <div id="jsstadmin-data-wrp">
           <form action="index.php" method="POST" name="adminForm" id="adminForm" >
                ...
                <div class="js-buttons-area">
                    <input type="submit" class="js-btn-save" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo Text::_('Save Job Type'); ?>" />
                    <a class="js-btn-cancel" href="index.php?option=com_jsjobs&c=jobtype&view=jobtype&layout=jobtypes"><?php echo Text::_('Cancel'); ?></a>
                </div>
