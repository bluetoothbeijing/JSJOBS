...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
        ...
        <div id="jsjobs-head">
            ...
            <a onclick="Joomla.submitbutton('jobtype.editjobtype');" class="jsjobs-add-link green-bg button" title="<?php echo Text::_('Add New').' '.Text::_('Job Type'); ?>">
                <img alt="<?php echo Text::_('Plus Icon'); ?>" src="components/com_jsjobs/include/images/plus.png"/>
                <?php echo Text::_('Add New').' '.Text::_('Job Type'); ?>
            </a>
        </div>
            ...
            <form action="index.php" method="post" name="adminForm" id="adminForm">
                ...
                <table class="adminlist" border="0" cellspacing="5" id="js-table">
                    ...
                    for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                        ...
                        $link = OutputFilter::ampReplace('index.php?option=' . $this->option . '&task=jobtype.editjobtype&cid[]=' . $row->id);
                        ?>
                        <tr valign="top" class="<?php echo "row$k"; ?>">
                            ...
                            <td align="center">
                                ...
                                $status_link = OutputFilter::ampReplace('index.php?option='.$this->option.'&task=common.makePublishUnpublish&for=jobtypes&status='.$status_value.'&cid[]='.$row->id);
                                ?>
