...
class jsjobsphpfunctions {
    ...
    public static function jsjobs_mb_substr($str, $start, $length = null, $encoding = 'UTF-8') {
        $output = null;
        if ($str !== null) {
            if ($length !== null) {
                $output = mb_substr($str, $start, $length, $encoding);
            } else {
                $output = mb_substr($str, $start);
            }
        }
        return $output;
    }
    ...
    public static function jsjobs_mb_strlen($str, $encoding = 'UTF-8'){
        $output = null;
        if ($str !== null) {
            if ($encoding !== null) {
                $output = mb_strlen($str, $encoding);
            } else {
    ...
    public static function sanitizeData($data){
        ...
        // create an instance of InputFilter
        $inputFilter = new InputFilter();
        // sanitize the input data using the STRING constant
        return $sanitizedData = $inputFilter->clean($data, 'STRING');
    }

    public static function jsjobs_strtotime($str){
