...
defined('_JEXEC') or die('Restricted access');
	...
	$db = JFactory::getDbo();
	$query = "SELECT * FROM `#__js_job_config` WHERE configname = 'version' OR configname = 'last_version' OR configname = 'last_step_updater'";
	$db->setQuery($query);
	...
	$mainfile = JPATH_COMPONENT_ADMINISTRATOR.'/views/jsjobs/tmpl/controlpanel.php';
