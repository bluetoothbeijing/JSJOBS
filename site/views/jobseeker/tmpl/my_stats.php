        ...
        ?>
            ...
            <div class="jsjobs-listing-stats-wrapper">
                <div class="jsjobs-icon-wrap">
                    <img class="jsjobs-img" src="<?php echo Uri::root();?>components/com_jsjobs/images/statsicon/resume.png">
                    <span class="stats-data-value"><?php echo $this->totalresume; ?></span>
                    <span class="stats-data-title"><?php echo Text::_('Resumes'); ?></span>
                </div>
                <div class="jsjobs-icon-wrap">
                     <img class="jsjobs-img" src="<?php echo Uri::root();?>components/com_jsjobs/images/statsicon/cover-letter.png">
                     <span class="stats-coverletterdata-value"><?php echo $this->totalcoverletters; ?></span>
                     <span class="stats-data-title"><?php echo Text::_('Cover Letters'); ?></span>
                </div>
            </div>
            <div class="jsjobs-listing-stats-wrapper">
            <div class="jsjobs_rs_heading"><?php echo Text::_('Stats');?> </div>
                  <table id="js-table">
                     <thead>
                         <tr>
                             <th>
                     ...
                     <tbody>
                          <tr class="bodercolor1_rs">
                              <td class="color3 bodercolor1"><?php echo Text::_('Resumes');?></td>
