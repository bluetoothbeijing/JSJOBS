  ...
  <div id="js_menu_wrapper">
    ...
    if ($this->mypurchasehistory_allowed == VALIDATE) { // employer 
        if (!empty($this->packages)) {
                        ...
                        <div class="jsjobs-purchasehistory-main">
                            <span class="jsjobs-title-wrap">
                                <span class="jsjobs-title-wrap-purchase">
                                    <a class="anchor" href="index.php?option=com_jsjobs&c=employerpackages&view=employerpackages&layout=package_buynow&jslayfor=detail&gd=<?php echo $package->id; ?>&Itemid=<?php echo $this->Itemid; ?>"><?php echo Text::_($package->title); ?></a>
                            </span>
                                ...
                                <div class="jsjobs-listing-datawrap-details">
                                    <div class="jsjobs-listing-wrap">
                                        <div class="jsjobs-values-wrap">
                                            ...
                                            <span class="stats_data_value">
                                                <?php 
                                                if ($package->companiesallow == -1) echo Text::_('Unlimited');
                                    ...
                                    <div class="jsjobs-listing-wrap">
                                        <div class="jsjobs-values-wrap">
                                            ...
                                            <span class="stats_data_value">
                                                <?php 
                                                    if ($package->jobsallow == -1) echo Text::_('Unlimited');
                                    ...
                                    <div class="jsjobs-listing-wrap">
                                        <div class="jsjobs-values-wrap bordernone">
                                            ...
                                            <span class="stats_data_value">
                                                <?php 
                                                if ($package->transactionverified == 1) $imgscr  = Uri::root().'components/com_jsjobs/images/publish-icon.png' ;
            ...
            ?>  
            <form action="<?php echo Route::_('index.php?option=com_jsjobs&c=purchasehistory&view=purchasehistory&layout=employerpurchasehistory&Itemid=' . $this->Itemid ,false); ?>" method="post">
